...
export default function SyntheticDataGenerator() {
  ...
  const handleTableNameSubmit = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.post('http://127.0.0.1:8000/api/get-table-columns/', { table_name: tableName });
  ...
  const downloadData = () => {
    ...
    a.href = url;
    a.download = `synthetic_data_${new Date().toISOString().split('T')[0]}.json`;
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div
                ...
                onClick={handleTableNameSelection}
              >
