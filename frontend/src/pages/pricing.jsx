          ...
          {plans.map((plan, index) => (
            <div 
              ...
              className={`bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 hover:-translate-y-2 ${
                plan.highlight ? 'border-2 border-orange-500 transform scale-105 md:scale-110 z-10 shadow-xl' : ''
              }`}
            >
              {plan.highlight && (
              ...
              <div className="p-6">
                ...
                <button className={`w-full py-3 px-4 rounded-md font-medium transition-colors duration-300 ${
                  plan.highlight 
